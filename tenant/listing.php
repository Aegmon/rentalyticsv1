...
<?php
 ...
 if (isset($_POST['rent'])) {
        ...
        $stmt = $conn->prepare("INSERT INTO application ( tenant_id, listing_id, status) VALUES ( ?, ?, ?)");
        $stmt->bind_param("iis", $id, $listing_id, $status);
...
?>
    ...
    <div class="modal-body">
        <div class="new-member-modal">
            ...
            <div class="form-group mb-20">
                <input type="number" class="form-control" name="monthly_rent" placeholder="Monthly Rent">
            </div>
            <div class="form-group mb-20">
                <input type="number" class="form-control" name="down_payment" placeholder="Down Payment">
            </div>
...
<input type="file" name="file" class="upload-avatar-input">
          ...
          <div class="row">
         <?php
$sql = "SELECT * FROM listing WHERE owner_id = $id and status = 'active'";
...
if ($result->num_rows > 0) {
    ...
    <input type="hidden" name="listing_id" value="'.$row["listing_id"].'">
       ...
       <button class="btn btn-primary btn-default btn-squared text-capitalize px-20 mb-10 global-shadow"  type="submit" name="rent" >Rent
                        </button>
</form>

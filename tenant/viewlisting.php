...
include('sidebar.php');
 ...
 $sql1 = "SELECT n_bedroom FROM listing
...
$query = "SELECT listing_id, COUNT(*) application_c FROM application WHERE listing_id = '$listing_id' AND status = 'approved' GROUP BY listing_id";
$result3 = mysqli_query($conn, $query);
if ($result3) {

  // Initialize n_bedroom variablez
  $application = 0;

  // Fetch the result as an associative array
  while ($row2 = mysqli_fetch_assoc($result3)) {

    $application = $row2['application_c'];
  }
}
    ...
    if ($check_result->num_rows > 0) {
      echo '<script>
        document.addEventListener("DOMContentLoaded", function() {
            Swal.fire({
                title: "Application with the same start and end date already exists",
                text: "Check your Application Details.",
                icon: "info"
            });
        });
    </script>';
            ...
            <div class="col-lg-12">
              <div class="shop-breadcrumb">
                <div class="breadcrumb-main">
                  ...
                  <!-- <?php  echo "beds/slots " .$noofbedroom . '<br>'."number of applcaition" .$application; ?> -->
    ...
    <span style="color:red;">
     ...
     <div class="product-item__button mt-lg-30 mt-sm-25 mt-20 d-flex flex-wrap">
        ...
        <div class="input-group mb-3">
            ...
            <?php
             if($noofbedroom == $application )
             {
              echo '  <div class="input-group">
              <button type="submit" name="rentnow" class="btn btn-success fs-6 text-white btn-default btn-squared border-1=0 ms-0" disabled>Rent Now</button>
          </div>';
          }else{
            echo ' <div class="input-group">

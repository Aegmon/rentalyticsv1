...
$contactNumber = $_POST['contactNumber'];
    ...
    // Update owner table
    $owner_query = "UPDATE owner SET name = '$name' and contactNumber = '$contactNumber' WHERE user_id = $user_id";
...
<div class="contents">
  <div class="container-fluid">
   ...
   <div class="horizontal-form">
    ...
    <div class="form-group row mb-25">
        <div class="col-sm-3 d-flex aling-items-center">
            <label for="inputEmailIcon" class="col-form-label color-dark fs-14 fw-500 align-center mb-10"> Contact Number</label>
        </div>
        <div class="col-sm-9">
            <div class="with-icon">
                <span class="lar uil-phone color-gray"></span>
                <input type="number" class="form-control ih-medium ip-gray radius-xs b-light" id="inputEmailIcon" name="contactNumber" value="<?php echo $contactNumber; ?>">
            </div>
        </div>
    </div>
    <div class="form-group row mb-25">

...
$date_of_application = date('Y-m-d H:i:s'); 
    ...
    $sql_update = "UPDATE application SET status = 'approved' , date_of_application = '$date_of_application' WHERE listing_id = '$listing_id'";
      $sql_update = "UPDATE listing SET status = 'rented'  WHERE listing_id = '$listing_id'";
        ...
        <ul class='orderDatatable_actions mb-0 d-flex flex-wrap'>
            ...
            <li>
               <form action='' method='post'>
                    ...
                    <button type='submit' name='verify'  class='edit'><i class='uil uil-edit'></i></button>
                </form>
            </li>
